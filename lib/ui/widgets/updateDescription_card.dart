...
class UpdateDescriptionCard extends StatefulWidget {
  final String title;
  final String description;
  final void Function(String, String,String?, String?) onDataChanged;
  const UpdateDescriptionCard({super.key, required this.onDataChanged, required this.title, required this.description});

  @override
  State<UpdateDescriptionCard> createState() => _UpdateDescriptionCardState();

}

class _UpdateDescriptionCardState extends State<UpdateDescriptionCard> {
